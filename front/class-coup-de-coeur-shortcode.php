 ...
 *   star_color  = hex     Couleur des étoiles (default: settings ou #222222)
...
class CoupDeCoeurShortcode {
            ...
            <div class="sj-cdc__stats">
                <div class="sj-cdc__rating-block">
                    ...
                    <div class="sj-cdc__stars">
                        <?php echo $this->stars_html($avg, $star_color); ?>
                    </div>
                </div>
    ...
    /** Génère des étoiles SVG partielles (comme RatingShortcode) */
    ...
    private function leaf_svg_left(): string {
    ...
    private function leaf_svg_right(): string {
